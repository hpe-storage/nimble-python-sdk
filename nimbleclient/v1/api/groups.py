...
class Group(Resource):
    ...
    - default_volume_limit                   : Default limit for a volume space usage as a percentage of volume size. Volume will be taken offline/made non-writable on exceeding
                                               its limit.
    ...
    - default_snap_limit                     : This attribute is deprecated. The array does not limit a volume's snapshot space usage. The attribute is ignored on input and
                                               returns max int64 value on output.
    - default_snap_limit_percent             : This attribute is deprecated. The array does not limit a volume's snapshot space usage. The attribute is ignored on input and
                                               returns -1 on output.
    ...
    - login_banner_reset                     : This will reset the banner to the version of the installed NOS. When login_banner_after_auth is specified, login_banner_reset can
                                               not be set to true.
...
class GroupList(Collection):
    ...
    def reboot(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'reboot',
                                                    id=id
                                                    )
    ...
    def halt(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'halt',
                                                    id=id,
                                                    force=force
                                                    )
    ...
    def test_alert(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'test_alert',
                                                    id=id,
                                                    level=level
                                                    )

    def software_update_precheck(self,
                                 id,
                                 skip_precheck_mask=None
                                 ):
        '''
        Run software update precheck.
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'software_update_precheck',
                                                    id=id,
                                                    skip_precheck_mask=skip_precheck_mask
                                                    )

    def software_update_start(self,
                              id,
                              skip_start_check_mask=None
                              ):
        '''
        Update the group software to the downloaded version.
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'software_update_start',
                                                    id=id,
    ...
    def software_download(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'software_download',
                                                    id=id,
                                                    version=version,
                                                    force=force
                                                    )
    ...
    def software_cancel_download(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'software_cancel_download',
                                                    id=id
                                                    )
    ...
    def software_update_resume(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'software_update_resume',
                                                    id=id
                                                    )

    def get_group_discovered_list(self,
                                  id,
                                  group_name=None
                                  ):
        '''
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'get_group_discovered_list',
                                                    id=id,
    ...
    def validate_merge(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'validate_merge',
                                                    id=id,
    ...
    def merge(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'merge',
                                                    id=id,
                                                    src_group_ip=src_group_ip,
                                                    src_group_name=src_group_name,
                                                    src_password=src_password,
    ...
    def get_eula(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'get_eula',
                                                    id=id,
                                                    force=force,
                                                    format=format,
                                                    locale=locale,
    ...
    def check_migrate(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'check_migrate',
                                                    id=id
                                                    )
    ...
    def migrate(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'migrate',
                                                    id=id
                                                    )
    ...
    def get_timezone_list(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'get_timezone_list',
                                                    id=id
                                                    )
