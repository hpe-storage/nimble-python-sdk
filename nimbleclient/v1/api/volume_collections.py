...
class VolumeCollection(Resource):
    ...
    def handover(self, replication_partner_id, invoke_on_upstream_partner=False, no_reverse=False, override_upstream_down=False):
        ...
        - no_reverse                 : Do not automatically reverse direction of replication. Using this argument will prevent the new owner from automatically replicating the
                                       volume collection to this node when the handover completes. The default behavior is to enable replication back to this node. Default:
                                       'false'.
        - invoke_on_upstream_partner : Invoke handover request on upstream partner. Default: 'false'. This operation is not supported for synchronous replication volume
                                       vollections.
...
class VolumeCollectionList(Collection):
    ...
    def promote(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'promote',
                                                    id=id
                                                    )
    ...
    def demote(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'demote',
                                                    id=id,
    ...
    def handover(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'handover',
                                                    id=id,
                                                    replication_partner_id=replication_partner_id,
                                                    invoke_on_upstream_partner=invoke_on_upstream_partner,
    ...
    def abort_handover(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'abort_handover',
                                                    id=id
                                                    )
    ...
    def validate(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'validate',
                                                    id=id
                                                    )
