...
class ActiveDirectoryMembershipList(Collection):
    ...
    def remove(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'remove',
                                                    id=id,
                                                    password=password,
                                                    user=user,
                                                    force=force
    ...
    def report_status(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'report_status',
                                                    id=id
                                                    )
    ...
    def test_user(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'test_user',
                                                    id=id,
                                                    name=name
                                                    )
    ...
    def test_group(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'test_group',
                                                    id=id,
                                                    name=name
                                                    )
