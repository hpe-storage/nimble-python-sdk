...
class InitiatorGroupList(Collection):
    ...
    def suggest_lun(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'suggest_lun',
                                                    id=id,
                                                    vol_id=vol_id
                                                    )

    def validate_lun(self,
                     id,
                     lun,
                     vol_id=None
                     ):
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'validate_lun',
                                                    id=id,
                                                    lun=lun,
                                                    vol_id=vol_id
                                                    )
