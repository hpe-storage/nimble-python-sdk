...
class ReplicationPartnerList(Collection):
    ...
    def pause(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'pause',
                                                    id=id
                                                    )
    ...
    def resume(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'resume',
                                                    id=id
                                                    )
    ...
    def test(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'test',
                                                    id=id
                                                    )
