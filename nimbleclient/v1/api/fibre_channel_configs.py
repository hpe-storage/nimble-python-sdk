...
class FibreChannelConfigList(Collection):
    ...
    def regenerate(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'regenerate',
                                                    id=id,
                                                    precheck=precheck,
    ...
    def hw_upgrade(self,
        ...
        return self._client.perform_resource_action(self.resource_type, id, 'hw_upgrade',
                                                    id=id
                                                    )
