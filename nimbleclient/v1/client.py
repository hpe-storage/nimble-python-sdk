...
from .api.roles import RoleList
from .api.fibre_channel_interfaces import FibreChannelInterfaceList
from .api.object_limits import ObjectLimitList
from .api.network_interfaces import NetworkInterfaceList
from .api.uninitialized_arrays import UninitializedArrayList
from .api.arrays import ArrayList
from .api.volume_families import VolumeFamilyList
...
from .api.hc_cluster_configs import HcClusterConfigList
...
from .api.folder_sets import FolderSetList
from .api.debug_log import DebugLogList
...
from .api.autosupport import AutosupportList
from .api.certificates import CertificateList
from .api.fibre_channel_sessions import FibreChannelSessionList
from .api.users import UserList
from .api.stats import StatList
...
from .api.health_checks import HealthCheckList
...
class Client:
    ...
    @property
    def object_limits(self):
        return ObjectLimitList(self._client)
    ...
    @property
    def uninitialized_arrays(self):
        return UninitializedArrayList(self._client)
    ...
    @property
    def volume_families(self):
        return VolumeFamilyList(self._client)
    ...
    @property
    def hc_cluster_configs(self):
        return HcClusterConfigList(self._client)
    ...
    @property
    def folder_sets(self):
        return FolderSetList(self._client)

    @property
    def debug_log(self):
        return DebugLogList(self._client)
    ...
    @property
    def autosupport(self):
        return AutosupportList(self._client)

    @property
    def certificates(self):
        return CertificateList(self._client)
    ...
    def health_checks(self):
        return HealthCheckList(self._client)
